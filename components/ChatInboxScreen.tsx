    ...
    try {
      ...
      const {
        ...
        await supabase
          .from("store_messages")
          .select(
            "id,conversation_id,sender_user_id,body,created_at,read_at,deleted_at,deleted_by_user_id"
          )
          .in(
            "conversation_id",
            conversationIds
